        ...
        case OP_ADD: {
            ...
            if(vm.stack[vm.top_stack].type == STR|| vm.stack[vm.top_stack-1].type == STR) {
                ...
                if(!(vm.stack[vm.top_stack].value)) {
                    ...
                    case INT: {
                        *val2 = (wchar)(*((long int*)vm.stack[vm.top_stack].value));
                    }
                    break;
                    case FLOAT: {
                        *val2 = (wchar)(*((float*)vm.stack[vm.top_stack].value));
                    }
                    break;
                    case DOUBLE: {
                        *val2 = (wchar)(*((double*)vm.stack[vm.top_stack].value));
                    }
                    break;
                    case CHAR: {
                ...
                if(!(vm.stack[vm.top_stack].value)) {
                    ...
                    switch(vm.stack[vm.top_stack].type) {
                    case INT: {
                        *val1 = (wchar)(*((long int*)vm.stack[vm.top_stack].value));
                    }
                    break;
                    case FLOAT: {
                        *val1 = (wchar)(*((float*)vm.stack[vm.top_stack].value));
                    }
                    break;
                    case DOUBLE: {
                        *val1 = (wchar)(*((double*)vm.stack[vm.top_stack].value));
                    }
                    break;
                    case CHAR: {
