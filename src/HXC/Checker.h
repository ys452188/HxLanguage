 ...
 */
int isFunctionRepeatDefine(IR_Function* fun, IR_Function** table,
                           int table_size) noexcept {
 ...
 */
int isClassRepeatDefine(IR_Class* cls, IR_Class** table, int table_size) noexcept {
